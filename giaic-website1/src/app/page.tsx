      ...
      <div className="bg-customBlue flex fixed w-full backdrop-blur-sm top-0 z-30">
        <nav className="flex h-16 items-center w-full justify-between md:m-auto">
          <div className="md:px-12 px-2 mt-16 ">
            <Image src="/governor house sindh logo.png" alt="logo" width={90} height={113} />
          </div>
        ...
        <div id="home" className="flex md:flex-row flex-col h-full w-full pt-16">
          <section className="md:w-1/2 w-full h-full flex md:flex-col flex-row py-10 items-center justify-center">
            <div className="  items-center justify-center md:pl-14 pl-7 md:pt-14 pt-7  ">
              <h1 className="text-bgcustomBlue md:text-6xl text-4xl font-extrabold pb-1"> Governor Sindh</h1>
              <h1 className="text-bgcustomBlue md:text-5xl text-3xl leading-relaxed py-1"> Kamran Khan Tessori</h1>
              <h1 className="text-sky-500 md:text-4xl text-2xl font-extrabold leading-normal py-1 "> Certified Cloud</h1>
              <h1 className="text-sky-500 md:text-4xl text-2xl font-extrabold leading-normal py-1 "> Applied Generative AI</h1>
              <h1 className="text-sky-500 md:text-4xl text-2xl font-extrabold leading-relaxed py-1 ">Engineering (GenEng) </h1>
              <h1 className="text-bgcustomBlue md:text-2xl text-lg font-extrabold leading-relaxed py-1">Earn Upto $5,000/ month</h1>
              <h1 className="text-bgcustomBlue md:text-2xl text-lg font-extrabold leading-relaxed py-1">Now Admissions Are Open In Hyderabad</h1>
            </div>
          </section>
